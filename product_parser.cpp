...
{
    Book *p = new Book("book", prodName_, price_, qty_, isbn_, author_);
    return p;
...
{
    Clothing *p = new Clothing("clothing", prodName_, price_, qty_, size_, brand_);
    return p;
...
{
    Movie *p = new Movie("movie", prodName_, price_, qty_, genre_, rating_);
    return p;
